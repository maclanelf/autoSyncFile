...
export interface SyncSchedule { id: number; remoteId: number; remoteName?: string; name: string; operation: "sync" | "copy"; source: string; destination: string; cron: string; startAt: string; enabled: boolean; lastRunAt?: string; createdAt: string; }
